 ...
 * @param {string} toLogin - Path to redirect if user isn't logged in, default is '/auth/login'
 * @param {string} toNoLogin - Path to redirect if user is logged in, default is '/'
